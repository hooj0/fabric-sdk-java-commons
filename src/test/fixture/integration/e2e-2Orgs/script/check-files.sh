...
function check_ca0() {
	...
	ls -l /etc/hyperledger/fabric-ca-server-config/fa84237e47dc62a87c15228337a81edd412152399ecc52aa8d94fe6f6bfb065b_sk
	ls -l /etc/hyperledger/fabric-ca-server-config/ca.org1.example.com-cert.pem
	ls -l /etc/hyperledger/fabric-ca-server-config/fa84237e47dc62a87c15228337a81edd412152399ecc52aa8d94fe6f6bfb065b_sk
	
	fabric-ca-server start -n ca0 ${V11_IDENTITIES_ALLOWREMOVE} ${V11_AFFILIATIONS_ALLOWREMOVE} --registry.maxenrollments -1 --ca.certfile /etc/hyperledger/fabric-ca-server-config/ca.org1.example.com-cert.pem --ca.keyfile /etc/hyperledger/fabric-ca-server-config/fa84237e47dc62a87c15228337a81edd412152399ecc52aa8d94fe6f6bfb065b_sk -b admin:adminpw ${ORG_HYPERLEDGER_FABRIC_SDKTEST_INTEGRATIONTESTS_CA_TLS} --tls.certfile /etc/hyperledger/fabric-ca-server-config/ca.org1.example.com-cert.pem --tls.keyfile /etc/hyperledger/fabric-ca-server-config/fa84237e47dc62a87c15228337a81edd412152399ecc52aa8d94fe6f6bfb065b_sk -d
}


function check_ca1() {
	ls -l /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem
	ls -l /etc/hyperledger/fabric-ca-server-config/98c434e5b56614a4a643cd3be17fb4aea9f0512d5185c12e1f470a8c9425b271_sk
	
	ls -l /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem
	ls -l /etc/hyperledger/fabric-ca-server-config/98c434e5b56614a4a643cd3be17fb4aea9f0512d5185c12e1f470a8c9425b271_sk
	
	fabric-ca-server start --registry.maxenrollments -1 --ca.certfile /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem --ca.keyfile /etc/hyperledger/fabric-ca-server-config/98c434e5b56614a4a643cd3be17fb4aea9f0512d5185c12e1f470a8c9425b271_sk -b admin:adminpw ${ORG_HYPERLEDGER_FABRIC_SDKTEST_INTEGRATIONTESTS_CA_TLS} --tls.certfile /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem --tls.keyfile /etc/hyperledger/fabric-ca-server-config/98c434e5b56614a4a643cd3be17fb4aea9f0512d5185c12e1f470a8c9425b271_sk -d
}
